            ...
            <div className="w-full max-w-md relative z-10 animate-slide-up">
                <div className="bg-black border border-white/10 rounded-[40px] p-8 md:p-12 shadow-2xl overflow-hidden relative group">
                    ...
                    <button 
                        ...
                        disabled={isProcessing}
                        className="w-full py-4 border border-white/10 rounded-full text-white font-bold hover:bg-white/5 transition-all flex items-center justify-center gap-3 text-xs uppercase tracking-widest"
                    >
